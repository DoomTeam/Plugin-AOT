...
import com.chenenyu.imgoptimizer.asm.AddPointAdapter
import com.gavin.plugin.lifecycle.LifecycleClassVisitor
        ...
        if (directoryInput.file.isDirectory()) {
            ...
            directoryInput.file.eachFileRecurse { File file ->
                ...
                if (checkClassFile(name)) {
                    ...
                    AddPointAdapter addPointAdapter = new AddPointAdapter(classWriter)
                    classReader.accept(addPointAdapter,EXPAND_FRAMES)
